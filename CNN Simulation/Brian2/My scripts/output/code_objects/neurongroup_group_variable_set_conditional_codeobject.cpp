...
const size_t _numrates = 10;
    ...
    double* __restrict  _ptr_array_neurongroup_rates = _array_neurongroup_rates;
...
const double _lio_statement_1 = 50.0 * 1.0;
...
for(int _idx=0; _idx<_N; _idx++)
{
    ...
    if (_cond)
    {
        ...
        double rates;
        rates = _lio_statement_1 + (1.0 * (i * 50));
        _ptr_array_neurongroup_rates[_idx] = rates;
